...
export { Assessments, Attachments, Authors, Books, Breadcrumbs, Configuration, Controls, Dashboards, Departments, Documents, Domains, EmailTemplates, Employees, Frameworks, Helpers, InternalAuditApproves, InternalAuditPreparation, InternalAuditPreparations, InternalAuditQuestionLists, InternalAuditQuestions, Microsoft, Notifications, Reports, RiskTreatments, Risks, Shared, StaticData, Volo };
