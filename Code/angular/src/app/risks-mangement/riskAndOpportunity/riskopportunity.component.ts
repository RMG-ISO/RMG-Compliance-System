...
@Component({
  selector: 'app-riskopportunity',
  templateUrl: './riskopportunity.component.html',
  styleUrls: ['./riskopportunity.component.scss']
})
export class riskopportunityComponent implements OnInit {
  FormMode = FormMode;
  items: any[];
  totalCount: number;
